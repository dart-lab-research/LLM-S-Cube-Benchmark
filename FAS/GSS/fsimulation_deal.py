...
def get_generatecsv():
    ...
    folder_path = './Data/GSS/'
# Read the data from the text file  
    input_file = r"/home/cyyuan/Data/GSS/gpt/35zero.txt"
    output_file = r'/home/cyyuan/Data/GSS/gpt/GSS_fsimulation_35zero.csv'  
    ...
    column_names = ["envir", "heal", "city"]  # Replace with your desired column names  
...
def merge():
    # 定义输入和输出文件路径  
    input_file1 = r"/home/cyyuan/Data/GSS/gpt/GSS_fsimulation_35zero.csv"   # 第一个CSV文件  
    input_file2 = folder_path + '1.csv'  # 第二个CSV文件  
    output_file = folder_path+"merged_output_35zero.csv"  # 合并后的CSV文件  

    columns_from_file1 = ["envir", "heal", "city"]  # 从第一个文件中抽取的列  
    columns_from_file2 = ["natenvir", "natheal","natcity"]  # 从第二个文件中抽取的列  

    # 定义新的列名  
    new_columns_file1 = {"envir": "fenvir", "heal": "fheal","city":"fcity"}  # 第一个文件的列重命名  
    new_columns_file2 = {"natenvir": "renvir", "natheal": "rheal","natcity":"rcity"}
    # 读取第一个CSV文件并抽取指定列  
...
def cal():
    input_file = folder_path+"merged_output_35zero.csv"
...
if __name__ == "__main__":
    get_generatecsv()
    merge()
    calculate_kl_for_columns(r"/home/cyyuan/Data/GSS/merged_output_35zero.csv")
    # drop()