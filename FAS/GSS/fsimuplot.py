...
def plot_the_distribution(result_df, output_dir):
    ...
    plot_actual_vs_prediction(result_df, result_df.index, 'rheal', 'fheal',
                              'heal_GT_vs_Pred', 'Sample Index', 'Miles', output_dir)
...
def main(file_path, output_dir):
    ...
    # 计算指标
    list1 = result_df['rheal'].tolist()
    list2 = result_df['fheal'].tolist()
    ...
    # 绘制 trpmiles 的分布对比图
    plot_distribution_comparison(result_df, 'rheal', 'fheal', 'Distribution_heal_F&R_G_400', output_dir)

    # # # 绘制 trpmiles 的散点对比图
    # plot_scatter_comparison(result_df, 'gts', 'responses', 'Scatter_heal_400', output_dir)
    ...
    print("KL divergence:", kl_trpmiles)
...
if __name__ == "__main__":
    ...
    input_path = folder_path + 'merged_output_Given.csv'
