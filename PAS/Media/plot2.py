...
def main(file_path):
    ...
    # 计算指标
    list1 = result_df[' preds'].tolist()
    
    list2 = result_df['llama3'].tolist()
    list3 = result_df[' llama3.1'].tolist()
    kl_trpmiles1 = calculate_kl_divergence(list1, list2)
    kl_trpmiles2 = calculate_kl_divergence(list1,list3)
    # kl_trpmiles2 = calculate_kl_divergence2(list3, list1)
    print("3:",round(kl_trpmiles1,4))
    print("31:",round(kl_trpmiles2,4))


if __name__ == "__main__":
    # 调用主函数并传入CSV文件路径
    main('/home/cyyuan/ACL2025/Data/Trell social media usage/duolun/conview_round2_zero.csv')
    main('/home/cyyuan/ACL2025/Data/Trell social media usage/duolun/conview_round2_few.csv')
    main('/home/cyyuan/ACL2025/Data/Trell social media usage/duolun/conview_round3_zero.csv')
    main('/home/cyyuan/ACL2025/Data/Trell social media usage/duolun/conview_round3_few.csv')
