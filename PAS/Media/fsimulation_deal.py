...
def get_generatecsv():
    ...
    folder_path = './Data/GSS/'
# Read the data from the text file  
    input_file = r"/home/cyyuan/Data/Trell social media usage/gpt/4few.txt"
    output_file = r'/home/cyyuan/Data/Trell social media usage/gpt/4few.csv'  
...
def merge():
    # 定义输入和输出文件路径  
    input_file1 = r"/home/cyyuan/Data/Trell social media usage/gpt/4few.csv"   # 第一个CSV文件  
    input_file2 = r"/home/cyyuan/Data/Trell social media usage/random_features.csv"  # 第二个CSV文件  
    output_file = r"/home/cyyuan/Data/Trell social media usage/gpt/4fewmerged.csv"  # 合并后的CSV文件  
...
if __name__ == "__main__":
    get_generatecsv()
    merge()
    #calculate_kl_for_columns(r"/home/cyyuan/Data/Trell social media usage/merged_features_2.csv")
    # drop()