...
def main():
    ...
    with open('/home/cyyuan/ACL2025/Data/Trell social media usage/duolun/acc.txt', 'a') as file:  # 使用 'a' 模式可以追加内容
        file.write(f"weekdays_round3_zero_ollama3:  {acc1}%\n")
        file.write(f"weekdays_round3_zero_ollama31:  {acc2}%\n")
    ...
    with open('/home/cyyuan/ACL2025/Data/Trell social media usage/duolun/acc.txt', 'a') as file:  # 使用 'a' 模式可以追加内容
        file.write(f"weekdays_round3_few_ollama3:  {acc1}%\n")
        file.write(f"weekdays_round3_few_ollama31:  {acc2}%\n")
