...
1.This person's participations on political activities are as follows: 
    ...
    This person has not given money to an organization concerned with a political or social issue. 
...
2.This person's participations on political activities are as follows: 
    This person has not worn a campaign button put a sticker on his/her car or placed a sign in window or in front of his/her house. 
...
3.This person's participations on political activities are as follows: 
...
4.This person's participations on political activities are as follows: 
    This person has not worn a campaign button put a sticker on his/her car or placed a sign in window or in front of his/her house. 
    This person has not attended a meeting to talk about political or social concerns. 
    This person has not given money to an organization concerned with a political or social issue. 
    This person has not joined in a protest march, rally, or demonstration. 
...
5.This person's participations on political activities are as follows: 
    This person has worn a campaign button put a sticker on his/her car or placed a sign in window or in front of his/her house. 
    This person has not attended a meeting to talk about political or social concerns. 
    This person has not given money to an organization concerned with a political or social issue. 
    This person has not joined in a protest march, rally, or demonstration. 
...
# 应用函数到每一行并生成描述性字符串
    ...
    with open('/home/cyyuan/ACL2025/Data/Anes2020/duolunC/acc.txt', 'a') as file:  # 使用 'a' 模式可以追加内容
        file.write(f"online_round2_zero_gpt3:  {acc1}%\n")
        file.write(f"online_round2_few_gpt3:  {acc2}%\n")
    ...
    with open('/home/cyyuan/ACL2025/Data/Anes2020/duolunC/acc.txt', 'a') as file:  # 使用 'a' 模式可以追加内容
        file.write(f"online_round2_zero_gpt4:  {acc1}%\n")
        file.write(f"online_round2_few_gpt4:  {acc2}%\n")
