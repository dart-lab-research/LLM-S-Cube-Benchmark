...
# 应用函数到每一行并生成描述性字符串
    ...
    with open(input_path, mode='r', newline='') as infile:
        ...
        for i, row in enumerate(reader):
            ...
            # 捕获转换失败的情况并跳过当前循环
                ...
                continue
            with open('/home/cyyuan/ACL2025/Data/Anes2020/duolungpt/biden_round3_inrow.csv', mode='a', newline='') as file:
                # 写入数据行
                writer = csv.writer(file)
    ...
    np.savetxt('/home/cyyuan/ACL2025/Data/Anes2020/duolungpt/biden_round3.csv', data, delimiter=',', header='gpt3.5_zero,gpt4_zero,gpt3.5few,gpt4few,gts', comments='', fmt='%s')  
    print("complete writing data into biden35.csv")
