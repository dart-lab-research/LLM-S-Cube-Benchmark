...
def part_info(row):
    ...
    #pred
    pred = "attended a meeting to talk about political or social concerns "
    gt = row['meeting']
...
'''
    ...
    question = f'''According to the information, can you speculate whether this person has {pred} or not?  
...
# 应用函数到每一行并生成描述性字符串
    ...
    with open('/home/cyyuan/ACL2025/Data/Anes2020/duolunC/acc.txt', 'a') as file:  # 使用 'a' 模式可以追加内容
        file.write(f"meeting_round3_zero_gpt3:  {acc1}%\n")
        file.write(f"meeting_round3_few_gpt3:  {acc2}%\n")
    ...
    with open('/home/cyyuan/ACL2025/Data/Anes2020/duolunC/acc.txt', 'a') as file:  # 使用 'a' 模式可以追加内容
        file.write(f"meeting_round3_zero_gpt4:  {acc1}%\n")
        file.write(f"meeting_round3_few_gpt4:  {acc2}%\n")
