...
def hh_info(row):
    ...
    # 
    #prediction
    polviews = row['natcrime']
    pred = "Government spending on fighting crime rate"
...
def main():
    ...
    np.savetxt('/home/cyyuan/ACL2025/Data/GSS/duolungpt/crime_round3_zerogpt3.csv', data, delimiter=',', header='responses,gts', comments='', fmt='%s')  
    print("complete writing data into crime_round2_zerogpt3.csv")

    data = np.column_stack((responses2, gts))  
    np.savetxt('/home/cyyuan/ACL2025/Data/GSS/duolungpt/crime_round3_zerogpt4.csv', data, delimiter=',', header='responses,gts', comments='', fmt='%s')  
    print("complete writing data into crime_round2_zerogpt4.csv")
    ...
    data = np.column_stack((responses1, gts))  
    np.savetxt('/home/cyyuan/ACL2025/Data/GSS/duolungpt/crime_round2_fewgpt3.csv', data, delimiter=',', header='responses,gts', comments='', fmt='%s')  
    print("complete writing data into crime_round2_fewgpt3.csv")

    data = np.column_stack((responses2, gts))  
    np.savetxt('/home/cyyuan/ACL2025/Data/GSS/duolungpt/crime_round2_fewgpt4.csv', data, delimiter=',', header='responses,gts', comments='', fmt='%s')  
    print("complete writing data into crime_round2_few31.csv")
