...
# 应用函数到每一行并生成描述性字符串
    ...
    with open('/home/cyyuan/ACL2025/Data/GSS/duolun/acc.txt', 'a') as file:  # 使用 'a' 模式可以追加内容
        file.write(f"allorglevel_round2_zero_gpt3:  {acc30}%\n")
        file.write(f"allorglevel_round2_zero_gpt4:  {acc31}%\n")
    ...
    with open('/home/cyyuan/ACL2025/Data/GSS/duolun/acc.txt', 'a') as file:  # 使用 'a' 模式可以追加内容
        file.write(f"allorglevel_round2_few_gpt3:  {acc30}%\n")
        file.write(f"allorglevel_round2_few_gpt4:  {acc31}%\n")
