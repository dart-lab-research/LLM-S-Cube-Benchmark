...
def main(file_path):
    ...
    list11 = result_df['gpt4'].tolist()
    list2 = result_df['gts'].tolist()

    kl_trpmiles = calculate_kl_divergence(list2, list1)
    #kl_trvlcmin = calculate_kl_divergence(trvlcmin_pred_list, trvlcmin_gt_list)
    print("gpt35: ", round(kl_trpmiles,4))

    kl_trpmiles = calculate_kl_divergence(list2, list11)
    #kl_trvlcmin = calculate_kl_divergence(trvlcmin_pred_list, trvlcmin_gt_list)
    print("gpt4: ",round(kl_trpmiles,4))
...
if __name__ == "__main__":
    # 调用主函数并传入CSV文件路径
    main(f'/home/cyyuan/ACL2025/Data/Income/duolungpt/Argfor_round2_zero.csv')
    main(f'/home/cyyuan/ACL2025/Data/Income/duolungpt/Argfor_round2_few.csv')
    main(f'/home/cyyuan/ACL2025/Data/Income/duolungpt/Argfor_round3_zero.csv')
    main(f'/home/cyyuan/ACL2025/Data/Income/duolungpt/Argfor_round3_few.csv')