...
# 应用函数到每一行并生成描述性字符串
    ...
    with open(input_path, mode='r', newline='') as infile:
        ...
        for i,row in enumerate(reader):
            ...
            try:
                ...
                continue 
            with open('/home/cyyuan/ACL2025/Data/RECS/duolungpt/KWH_round2_zero_inrow.csv', mode='a', newline='', encoding='utf-8') as file:
    ...
    np.savetxt('/home/cyyuan/ACL2025/Data/RECS/duolungpt/KWH_round2_zero.csv', data, delimiter=',', header='gpt35,gpt4,gts', comments='', fmt='%s')  
    ...
    with open(input_path, mode='r', newline='') as infile:
        ...
        for i,row in enumerate(reader):
            ...
            responses2.append(response2)
            gts.append(gt)
            with open('/home/cyyuan/ACL2025/Data/RECS/duolungpt/KWH_round2_few_inrow.csv', mode='a', newline='', encoding='utf-8') as file:
                writer = csv.writer(file)
                writer.writerow([response1, response2, gt])
            print(f"No:{i}")
            if i>=100:
    ...
    if responses1.shape[0] != gts.shape[0] or responses2.shape[0]!=gts.shape[0]:  
        raise ValueError("responses 和 gts 数组的长度必须相同")  
    data = np.column_stack((responses1, responses2, gts))  
    np.savetxt('/home/cyyuan/ACL2025/Data/RECS/duolungpt/KWH_round2_few.csv', data, delimiter=',', header='gt35,gpt4,gts', comments='', fmt='%s')  
    ...
    with open(input_path, mode='r', newline='') as infile:
        ...
        for i,row in enumerate(reader):
            ...
            responses2.append(response2)
            gts.append(gt)
            with open('/home/cyyuan/ACL2025/Data/RECS/duolungpt/KWH_round3_zero_inrow.csv', mode='a', newline='', encoding='utf-8') as file:
                writer = csv.writer(file)
                writer.writerow([response1, response2, gt])
            print(f"No:{i}")
            if i>=100:
    ...
    if responses1.shape[0] != gts.shape[0] or responses2.shape[0]!=gts.shape[0]:  
        raise ValueError("responses 和 gts 数组的长度必须相同")  
    data = np.column_stack((responses1, responses2, gts))  
    np.savetxt('/home/cyyuan/ACL2025/Data/RECS/duolungpt/KWH_round3_zero.csv', data, delimiter=',', header='gpt35,gpt4,gts', comments='', fmt='%s')  
    print("complete writing data into zero.csv")
    ...
    with open(input_path, mode='r', newline='') as infile:
        ...
        for i,row in enumerate(reader):
            ...
            responses2.append(response2)
            gts.append(gt)
            with open('/home/cyyuan/ACL2025/Data/RECS/duolungpt/KWH_round3_few_inrow.csv', mode='a', newline='', encoding='utf-8') as file:
                writer = csv.writer(file)
                writer.writerow([response1, response2, gt])
            print(f"No:{i}")
            if i>=100:
    ...
    if responses1.shape[0] != gts.shape[0] or responses2.shape[0]!=gts.shape[0]:  
        raise ValueError("responses 和 gts 数组的长度必须相同")  
    data = np.column_stack((responses1, responses2, gts))  
    np.savetxt('/home/cyyuan/ACL2025/Data/RECS/duolungpt/KWH_round3_few.csv', data, delimiter=',', header='gt35,gpt4,gts', comments='', fmt='%s')  
    print("complete writing data into few.csv")
