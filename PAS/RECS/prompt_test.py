...
few_examples = '''
        ...
        Here are some examples and answers:
            1. This person, who is a 82-year-old male, whose employment status is Retired and lives in the state New Mexico.
            Besides, this person's race is White Alone and the number of household members is 1, while the number of weekdays someone is at home most or all of the day is 3 days.
            Moreover, the total household income is $40,000 - $49,999.
            ...
            2. This person, who is a 70-year-old male, whose employment status is Retired and lives in the state South Carolina.
            Besides, this person's race is White Alone and the number of household members is 2, while the number of weekdays someone is at home most or all of the day is 5 days.
            Moreover, the total household income is $35,000 - $39,999.
...
# 应用函数到每一行并生成描述性字符串
    ...
    with open(input_path, mode='r', newline='') as infile:
        ...
        for i,row in enumerate(reader):
            ...
            try:
                # response1 = float(ol3(conversation_history))  # 尝试将返回值转换为 float
                # response2 = float(ol31(conversation_history))
    ...
    with open('/home/cyyuan/ACL2025/Data/RECS/duolun/acc.txt', 'a') as file:  # 使用 'a' 模式可以追加内容
        file.write(f"UGASHERE_round2_zero_gpt35:  {acc1}%\n")
        file.write(f"UGASHERE_round2_zero_gpt4:  {acc2}%\n")
    ...
    with open('/home/cyyuan/ACL2025/Data/RECS/duolun/acc.txt', 'a') as file:  # 使用 'a' 模式可以追加内容
        file.write(f"UGASHERE_round2_few_gpt35:  {acc1}%\n")
        file.write(f"UGASHERE_round2_few_gpt4:  {acc2}%\n")
    ...
    with open('/home/cyyuan/ACL2025/Data/RECS/duolun/acc.txt', 'a') as file:  # 使用 'a' 模式可以追加内容
        file.write(f"UGASHERE_round3_zero_gpt35:  {acc1}%\n")
        file.write(f"UGASHERE_round3_zero_gpt4:  {acc2}%\n")
    ...
    with open('/home/cyyuan/ACL2025/Data/RECS/duolun/acc.txt', 'a') as file:  # 使用 'a' 模式可以追加内容
        file.write(f"UGASHERE_round3_few_gpt35:  {acc1}%\n")
        file.write(f"UGASHERE_round3_few_gpt4:  {acc2}%\n")
