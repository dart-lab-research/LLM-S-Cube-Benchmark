...
def generate_description(row):
    ...
    usage_info = f'''
When it comes to energy use, for this person, {gas}, {natural_gas_used} and {propane_used}.
...
few_examples = '''
        ...
        Here are some examples and answers:
            1. This person, who is a 54-year-old female, whose employment status is Not employed and lives in the state Texas.
            Besides, this person's race is White Alone and the number of household members is 4, while the number of weekdays someone is at home most or all of the day is 5 days.
            Moreover, the total household income is $100,000 - $149,999.
            ...
            Moreover, for this person, Fuel oil is not used, Solar thermal is not used and Wood is used. At the same time, for this person, Natural gas is not used for cooking and Propane is not used for cooking. 
            The answer is 1
...
# 应用函数到每一行并生成描述性字符串
    ...
    with open('/home/cyyuan/ACL2025/Data/RECS/duolun/acc.txt', 'a') as file:  # 使用 'a' 模式可以追加内容
        file.write(f"USEEL_round3_zero_ollama3:  {acc1}%\n")
        file.write(f"USEEL_round3_zero_ollama31:  {acc2}%\n")
    ...
    with open('/home/cyyuan/ACL2025/Data/RECS/duolun/acc.txt', 'a') as file:  # 使用 'a' 模式可以追加内容
        file.write(f"USEEL_round3_few_ollama3:  {acc1}%\n")
        file.write(f"USEEL_round3_few_ollama31:  {acc2}%\n")
